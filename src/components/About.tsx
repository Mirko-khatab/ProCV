    ...
    <div>
      ...
      <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow mt-36">
        ...
        <div className="flex items-center  flex-col md:flex-row justify justify-center evenly">
          <div className="p-4">
            <div className="text-center mb-2 opacity-90">
            ...
            <div className="pt-8 flex border-t border-gray-200 w-44 mx-auto text-gray-500 items-center justify-between">
              <a href="https://m.facebook.com/mirko.kawa.921">
                <svg
                  width="30"
                  height="30"
                  fill="currentColor"
              ...
              <a href="https://twitter.com/mirko_div">
                <svg
                  width="30"
                  height="30"
                  fill="currentColor"
              ...
              <a href="https://www.linkedin.com/in/mirko-kawa-342093212/">
                <svg
                  width="30"
                  height="30"
                  fill="currentColor"
